"""Replace FASTAPI_GUIDE with comprehensive 23-phase version."""

NEW_GUIDE = r"""export const FASTAPI_GUIDE = [
  {
    phase: '01',
...
old_start = content.index('export const FASTAPI_GUIDE = [')
old_end   = content.index('export const FLASK_GUIDE = [', old_start)
...
print('Done. FastAPI guide replaced successfully.')
