"""Replace FLASK_GUIDE with comprehensive 23-phase version."""

NEW_GUIDE = r"""export const FLASK_GUIDE = [
  {
    phase: '01',
...
old_start = content.index('export const FLASK_GUIDE = [')
# Flask guide is the last guide — replace from its start to end of file (closing ])
old_end   = len(content)  # replace to end

new_content = content[:old_start] + NEW_GUIDE.strip() + '\n'

with open('C:/manmadha/Student-project/FrontEnd/src/pages/deployment/guideData.js', 'w', encoding='utf-8') as f:
    f.write(new_content)

print('Done. Flask guide replaced successfully.')
