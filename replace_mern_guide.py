"""Replace MERN_GUIDE in guideData.js with comprehensive 29-phase version."""

NEW_GUIDE = r"""export const MERN_GUIDE = [
  {
    phase: '01',
...
old_start = content.index('export const MERN_GUIDE = [')
old_end   = content.index('export const NEXTJS_GUIDE = [', old_start)
...
print('Done. MERN guide replaced successfully.')
